<?=anchor('questions', 'Select all')?>,
<?=anchor('questions?select=unanswered', 'Select unanswered')?>,
<?=anchor('questions?sort=newest', 'Sort by date')?>,
<?=anchor('questions?sort=vote', 'Sort by vote')?>
